...
import "./IOnboardingDeviceNFT.sol";
import "./OnboardingDeviceNFT.sol";
 ...
 * @author Lolplz
 */
contract IoTOnBoardingProtocol {
    struct Device {
    ...
    function _addDevice(
        ...
        _deviceCount += 1;
        IOnboardingDeviceNFT(nftContract).safeMint(
     ...
     * @param _name The name of the Onboarding Group NFT contract.
     * @param _symbol The symbol of the Onboarding Group NFT contract.
     * @param _firmwareHash The firmware hash of the device.
     * @param _deviceDataHash The device data hash.
     * @param _deviceGroupIdHash The device group ID hash.
     * @param _deviceId The device address.
    ...
    function registerGroup(
        ...
        OnboardingDeviceNFT nftContract = (new OnboardingDeviceNFT)(_name, _symbol);
        ...
        public
    {
        ...
        IOnboardingDeviceNFT(deviceIdToDevice[_deviceId].nftContract)
            .safeTransferFrom(
                msg.sender,
                _subscriber,
                uint256(uint160(_deviceId)),
     ...
     * @param _deviceGroupIdHash The device group ID hash.
     * @param _deviceId The device address.
     * @return The RIOnboardingOT key for the device.
     */
     ...
     */
    function generateOnboardingKeyForSubscriber(address _deviceId)
        public
        view
