...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/token/ERC721/ERC721.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/token/ERC721/extensions/ERC721URIStorage.sol";
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/utils/Counters.sol";

/**
 * @title IoTOnBoardingProtocol
 * @dev Contract for managing the IoT OnBoarding Protocol and device registration.
 * @author Lolplz
 */
contract IoTOnBoardingProtocol is ERC721, ERC721URIStorage {
    ...
    constructor() ERC721("OnBoarding Protocol", "OBP") {}
    ...
    /**
     * @dev Generates a OnBoarding key for a device.
     * @param _firmwareHash The firmware hash of the device.
     * @param _deviceDataHash The device data hash.
     * @param _deviceGroupIdHash The device group ID hash.
     * @param _deviceId The device Token Id.
     * @return The OnBoarding key for the device.
     */
    function generateOnboardingKeyForDevice(
        bytes32 _firmwareHash,
        bytes32 _deviceDataHash,
        bytes32 _deviceGroupIdHash,
        uint _deviceId
    ...
    /**
     * @dev Generates a Onboarding key for the subscriber of a device.
     * @param _deviceId The device Token Id.
     * @return The Onboarding key for the subscriber of the device.
     */
    function generateOnboardingKeyForSubscriber(uint _deviceId)
        public
        view
